<?php  
class ControllerProductIphone extends Controller {
	private $error = array(); 
...
//			$this->data['points'] = $product_info['points'];
			...
			if ($product_info['image']) {
				$this->data['thumb'] = $this->model_tool_image->resize('data/Apple/iphone-unlock.jpg', 368, 554);
			} else {
				$this->data['thumb'] = '';
			}
...
//			$this->data['attribute_groups'] = $this->model_catalog_product->getProductAttributes($this->request->get['product_id']);
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/iphone.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/product/iphone.tpl';
			} else {
