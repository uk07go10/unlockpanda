	...
	public function expressComplete() {
		...
		if ($redirect == '') {
			...
			if($result['ACK'] == 'Success') {
				...
				if($order_status_id == $this->config->get('pp_express_completed_status_id')) {
					$this->model_checkout_order->sendMail(
						$data['email'],
						"UnlockPanda order confirmation: " . $order_id,
						"Our team is now working on your order. You will receive it via email as soon as it's ready. " .
						"Delivery times may depend on your phone's brand, model and carrier.\r\n\r\n" .
						"Please add sales@unlockpanda.com to your contacts to prevent your email being delivered to junk-mail.\r\n\r\n" .
						"If you have any questions, please email us at support@unlockpandasupport.zendesk.com.\r\n\r\n"  .
						"You can check on your order by visiting this link: " .
						"http://www.unlockpanda.com/index.php?route=information/orderstatus\r\n" .
