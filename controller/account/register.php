	...
	private $error = array();
  	...
  	public function index() {
		...
		if ($this->config->get('config_account_id')) {
			...
			if ($information_info) {
				$this->data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/info', 'information_id=5', 'SSL'), $information_info['title'], $information_info['title']);
			} else {
