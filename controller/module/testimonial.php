...
class ControllerModuletestimonial extends Controller {
	protected function index($setting) {
		...
		$this->data['t_head'] = $this->language->get('t_head');
		$this->data['t_name1'] = $this->language->get('t_name1');
		$this->data['t_desc1'] = $this->language->get('t_desc1');
		$this->data['t_name2'] = $this->language->get('t_name2');
		$this->data['t_desc2'] = $this->language->get('t_desc2');
		$this->data['t_name3'] = $this->language->get('t_name3');
		$this->data['t_desc3'] = $this->language->get('t_desc3');
		$this->data['t_name4'] = $this->language->get('t_name4');
		$this->data['t_desc4'] = $this->language->get('t_desc4');
