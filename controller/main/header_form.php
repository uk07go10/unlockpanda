 ...
 */
class ControllerMainHeaderForm extends Controller
{
    protected function index()
    {

        $this->document->addScript("/catalog/view/theme/web/js/home.js");

        $this->document->addStyle('https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/13.0.2/css/intlTelInput.css');
        $this->document->addScript('https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/13.0.2/js/intlTelInput.min.js');
        ...
        $this->template = 'web/template/main/header_form.tpl';
        $this->render();
    }
