...
class ControllerMainCategory extends Controller {
    public function index() {
        ...
        if (isset($this->request->get['limit']) && is_integer($this->request->get['limit'])) {
        ...
        if ($category_info) {
            $this->document->setTitle($category_info['name'] . ' quick unlock');
            ...
            $this->template = 'ur/template/main/category.tpl';
        } else {
