...
<div class="footer-container">
    <div class="footer-row">
        ...
        <div>
            ...
            <ul class="footer-menu">
                ...
                <li><a href="/delivery-policy">Política de Entrega</a></li>
                <li><a href="/apply-for-a-refund">Solicitar Reembolso</a></li>
            </ul>
        </div>
    ...
    <div class="footer-reserved-row">
        <p class="reserved-text">©2023. <strong>UnlockPanda.com</strong>. Todos los derechos reservados.</p>
        <p class="policy-links">
            <a href="/privacy-policy">Política de Privacidad </a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="/terms-conditions">Términos y Condiciones</a></p>
    </div>
</div>
<?php }  ?>
<!-- Footer -->
