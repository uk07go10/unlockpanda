<div id="cart">
  <a href="<?php echo $cart; ?>"><span class="pd_img"><img src="catalog/view/theme/unlock/image/bag.png" alt="" class="img-responsive"></span><span class="pd_item" id="cart-total"><?php echo $text_items; ?></span></a>
  <!--<div class="content">
