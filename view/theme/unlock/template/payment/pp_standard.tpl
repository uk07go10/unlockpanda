...
<a id="button-confirm" onclick="validateTerms();" style="text-decoration: none; cursor: pointer;">
  <img src="https://www.paypalobjects.com/en_GB/i/btn/btn_xpressCheckout.gif" alt="Pay with PayPal" style="float:right;"/>
</a>
