...
<?php // echo $column_right; ?>
                            ...
                            afterClose: function() {
                                setTimeout(function() {
                                    ...
                                    lessModelsWarningCarriers.forEach(function(value) {
                                        if (carrierText.toLowerCase().indexOf(value) > -1) {
                                            hide = false;
                                        }
                                    });
                    ...
                    <div id="header_form" class="round_corners" style="display: block">
                        ...
                        <div class="form_content">
                            ...
                            <div id="info_box" class="float_left field_input" style="margin: 0; display: none;">
                                ...
                                <div class="field">
                                    <div style="text-align: center;">
                                        <span id="select_info_box" title="<?php echo $text_less_models_text ?>" style="cursor: pointer; color: #0A98CA; text-decoration: underline; text-transform: none;"><?php echo $text_less_models_title ?></span>
                                    </div>
                                </div>
                            </div>
                            <div id="inputdiv" class="float_left field_input">
                            ...
                            <div id="inputdiv" class="float_left field_input">
                                <span class="wrong"></span>
                                <div class="field">
                                    <input type="text" id="email" name="email" value="<?php echo $text_formemail; ?>" onfocus="this.value = (this.value.indexOf('@') > -1 ? this.value : '');" />
                                    <p id="email-correction-block" style="text-transform: none; text-align: right; margin-top: 5px; display: none;">
                                        <span id="email-correction-text"></span> <a id="email-correction-value" style="text-decoration: underline;"></a>?
                                    </p>
                                </div>
                                <div class="tool_tip">
    ...
    <script type="text/javascript" charset="utf-8">
        $(function() {
            ...
            var suggestion_text, domain_problem;
            if(language == 'es') {
                suggestion_text = 'Querías decir';
                domain_problem = 'Desafortunadamente btinternet puede rechazar nuestro correo. Por favor utiliza otro email para asegurar que recibirás tu orden.';
            } else {
                suggestion_text = 'Did you mean';
                domain_problem = 'Unfortunately btinternet might reject our email. Please use another email to ensure that you receive your order.';
            }

            $('#email-correction-text').text(suggestion_text);
                        ...
                        $modelSelect.scombobox("change", function () {
                            valueHandler($modelSelect, function() {
                                ...
                                $.getJSON('index.php?route=common/header/ajaxGetProduct&prod_id=' + $modelSelect.scombobox("val"), function (json) {
                                    ...
                                    $('#phone_price').find('.price').html('<span class="delivery"><?php echo $text_deltime; ?> ' + deliver_time + '</span><br /><span class="delivery"><?php echo $text_formprice; ?> </span>$' + price);
