                    ...
                    <div class="cart-total">
                        ...
                        <table style="">
                            ...
                            <tr id="paypal_payment">
                                <td colspan="2">
                                    <input type="checkbox" name="newsletter" value="1" id="newsletter" checked /><span class="cartchecks"><?php echo $text_newsletter; ?></a></span><br /><br />
                                    <input type="checkbox" name="agree" value="1" id="agree" /><span class="cartchecks"><?php echo $text_agree; ?><a alt="Terms & Conditions" href="index.php?route=information/information/info&amp;information_id=5" class="fancybox" style="font-size:14px!important;"><b><?php echo $text_terms; ?></b></a></span>
